#' read_EV_exports_v2:  Read in a directory of .csv files exported from Echoview
#'
#' @description Read in a directory of .csv files
#' exported from Echoview.   The function preserves the cells by depth. 
#' Uses packages readxl, readr, purrr, and dplyr.  This version (unlike read_EV_exports) does
#' not need to have the directory variable
...
read_EV_exports_v2<-function(SurveyName, DirNameFile,database=1,exportloc=1,...){
