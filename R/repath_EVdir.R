...
### repath_EVdir.R
# Script to take a directory of EV files and reset the path
# Written by RT 2022
# Requires an excel file (put as input?) that says what the paths are
# Each row is a survey (survey_name?), and each column is a path or file name
# Inputs: SurveyName, excel file name of paths, ni is an optional argument for which 
# file to start with (default ni=1 is the first file).
###
# Excel file:
