...
The goal of FEATR is to provide a tidy package of frequently used R files for Echoview processing.

## Installation

You can install the released version of FEATR from [CRAN](https://CRAN.R-project.org) with:
